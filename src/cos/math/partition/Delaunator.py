#!/usr/bin/python
# Filename: Delaunator.py
# Description: Implementation of the Delunay triangulator

# This is the code for the Delaunator-Python implementation, ported from Mapbox's Delaunator Project (JavaScript).
# License:  GNU LESSER GENERAL PUBLIC LICENSE
# Github: https://github.com/HakanSeven12/Delaunator-Python
