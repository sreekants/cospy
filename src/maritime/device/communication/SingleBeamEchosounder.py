#!/usr/bin/python
# Filename: SingleBeamEchosounder.py
# Description: Implementation of the SingleBeamEchosounder device

from cos.core.kernel.Device import Device
from cos.core.utilities.Errors import ErrorCode


class SingleBeamEchosounder(Device):
