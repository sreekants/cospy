#!/usr/bin/python
# Filename: RestrictedAbilityManeuver.py
# Description: Implementation of the RestrictedAbilityManeuver class
...
class RestrictedAbilityManeuver(PlannedVesselBehavior):
...
if __name__ == "__main__":
    test = RestrictedAbilityManeuver(None, None)
